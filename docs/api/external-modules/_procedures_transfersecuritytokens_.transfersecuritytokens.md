...
+ **new TransferSecurityTokens**\(`args`: [TransferSecurityTokensProcedureArgs](), `context`: [Context]()\): [_TransferSecurityTokens_]()
...
**Returns:** [_TransferSecurityTokens_]()

## Properties

### `Protected` args

• **args**: [_TransferSecurityTokensProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.TransferSecurityTokens
