...
+ **new SignDisableControllerAck**\(`args`: [SignDisableControllerAckProcedureArgs](), `context`: [Context]()\): [_SignDisableControllerAck_]()
...
**Returns:** [_SignDisableControllerAck_]()

## Properties

### `Protected` args

• **args**: [_SignDisableControllerAckProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.SignDisableControllerAck
