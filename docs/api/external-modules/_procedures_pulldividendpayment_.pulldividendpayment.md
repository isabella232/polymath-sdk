...
+ **new PullDividendPayment**\(`args`: [PullDividendPaymentProcedureArgs](), `context`: [Context]()\): [_PullDividendPayment_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.PullDividendPayment
