...
+ **new TransferErc20**\(`args`: [TransferErc20ProcedureArgs](), `context`: [Context]()\): [_TransferErc20_]()
...
**Returns:** [_TransferErc20_]()

## Properties

### `Protected` args

• **args**: [_TransferErc20ProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.TransferErc20
