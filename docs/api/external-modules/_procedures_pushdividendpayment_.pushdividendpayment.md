...
+ **new PushDividendPayment**\(`args`: [PushDividendPaymentProcedureArgs](), `context`: [Context]()\): [_PushDividendPayment_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.PushDividendPayment
