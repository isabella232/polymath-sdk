...
* Procedure‹[LaunchTieredStoProcedureArgs](), [TieredSto]()›
...
+ **new LaunchTieredSto**\(`args`: [LaunchTieredStoProcedureArgs](), `context`: [Context]()\): [_LaunchTieredSto_]()
...
**Returns:** [_LaunchTieredSto_]()

## Properties

### `Protected` args

• **args**: [_LaunchTieredStoProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.LaunchTieredSto
...
▸ **prepareTransactions**\(\): _Promise‹PostTransactionResolver‹_[_TieredSto_]()_, TransactionReceiptWithDecodedLogs››_
...
**Returns:** _Promise‹PostTransactionResolver‹_[_TieredSto_]()_, TransactionReceiptWithDecodedLogs››_
