...
+ **new DisableFeature**\(`args`: [DisableFeatureProcedureArgs](), `context`: [Context]()\): [_DisableFeature_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.DisableFeature
