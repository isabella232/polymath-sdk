...
+ **new ModifyDividendsDefaultExclusionList**\(`args`: [ModifyDividendsDefaultExclusionListProcedureArgs](), `context`: [Context]()\): [_ModifyDividendsDefaultExclusionList_]()
...
**Returns:** [_ModifyDividendsDefaultExclusionList_]()

## Properties

### `Protected` args

• **args**: [_ModifyDividendsDefaultExclusionListProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ModifyDividendsDefaultExclusionList
