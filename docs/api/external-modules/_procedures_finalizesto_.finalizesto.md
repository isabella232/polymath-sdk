...
+ **new FinalizeSto**\(`args`: [FinalizeStoProcedureArgs](), `context`: [Context]()\): [_FinalizeSto_]()
...
**Returns:** [_FinalizeSto_]()

## Properties

### `Protected` args

• **args**: [_FinalizeStoProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.FinalizeSto
