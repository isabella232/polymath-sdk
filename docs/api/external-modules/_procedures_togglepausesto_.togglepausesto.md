...
+ **new TogglePauseSto**\(`args`: [TogglePauseStoProcedureArgs](), `context`: [Context]()\): [_TogglePauseSto_]()
...
**Returns:** [_TogglePauseSto_]()

## Properties

### `Protected` args

• **args**: [_TogglePauseStoProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.TogglePauseSto
