...
+ **new ToggleFreezeTransfers**\(`args`: [ToggleFreezeTransfersProcedureArgs](), `context`: [Context]()\): [_ToggleFreezeTransfers_]()
...
**Returns:** [_ToggleFreezeTransfers_]()

## Properties

### `Protected` args

• **args**: [_ToggleFreezeTransfersProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ToggleFreezeTransfers
