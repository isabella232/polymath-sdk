...
+ **new ReclaimFunds**\(`args`: [ReclaimFundsProcedureArgs](), `context`: [Context]()\): [_ReclaimFunds_]()
...
**Returns:** [_ReclaimFunds_]()

## Properties

### `Protected` args

• **args**: [_ReclaimFundsProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ReclaimFunds
