...
+ **new ControllerTransfer**\(`args`: [ControllerTransferProcedureArgs](), `context`: [Context]()\): [_ControllerTransfer_]()
...
**Returns:** [_ControllerTransfer_]()

## Properties

### `Protected` args

• **args**: [_ControllerTransferProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ControllerTransfer
