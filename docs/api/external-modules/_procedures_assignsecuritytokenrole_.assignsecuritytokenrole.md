...
+ **new AssignSecurityTokenRole**\(`args`: [AssignSecurityTokenRoleProcedureArgs](), `context`: [Context]()\): [_AssignSecurityTokenRole_]()
...
**Returns:** [_AssignSecurityTokenRole_]()

## Properties

### `Protected` args

• **args**: [_AssignSecurityTokenRoleProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.AssignSecurityTokenRole
