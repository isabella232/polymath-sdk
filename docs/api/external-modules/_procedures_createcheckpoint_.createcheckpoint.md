...
+ **new CreateCheckpoint**\(`args`: [CreateCheckpointProcedureArgs](), `context`: [Context]()\): [_CreateCheckpoint_]()
...
**Returns:** [_CreateCheckpoint_]()

## Properties

### `Protected` args

• **args**: [_CreateCheckpointProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.CreateCheckpoint
...
▸ **prepareTransactions**\(\): _Promise‹PostTransactionResolver‹_[_Checkpoint_]()_, TransactionReceiptWithDecodedLogs››_
...
**Returns:** _Promise‹PostTransactionResolver‹_[_Checkpoint_]()_, TransactionReceiptWithDecodedLogs››_
