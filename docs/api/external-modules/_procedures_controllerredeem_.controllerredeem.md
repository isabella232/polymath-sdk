...
+ **new ControllerRedeem**\(`args`: [ControllerRedeemProcedureArgs](), `context`: [Context]()\): [_ControllerRedeem_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ControllerRedeem
