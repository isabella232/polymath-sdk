...
+ **new LaunchSimpleSto**\(`args`: [LaunchSimpleStoProcedureArgs](), `context`: [Context]()\): [_LaunchSimpleSto_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.LaunchSimpleSto
...
▸ **prepareTransactions**\(\): _Promise‹PostTransactionResolver‹_[_SimpleSto_]()_, TransactionReceiptWithDecodedLogs››_
...
**Returns:** _Promise‹PostTransactionResolver‹_[_SimpleSto_]()_, TransactionReceiptWithDecodedLogs››_
