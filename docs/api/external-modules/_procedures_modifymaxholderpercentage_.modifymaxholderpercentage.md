...
+ **new ModifyMaxHolderPercentage**\(`args`: [ModifyMaxHolderPercentageProcedureArgs](), `context`: [Context]()\): [_ModifyMaxHolderPercentage_]()
...
**Returns:** [_ModifyMaxHolderPercentage_]()

## Properties

### `Protected` args

• **args**: [_ModifyMaxHolderPercentageProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ModifyMaxHolderPercentage
