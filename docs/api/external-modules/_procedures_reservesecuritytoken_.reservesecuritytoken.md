...
* Procedure‹[ReserveSecurityTokenProcedureArgs](), [SecurityTokenReservation]()›
...
+ **new ReserveSecurityToken**\(`args`: [ReserveSecurityTokenProcedureArgs](), `context`: [Context]()\): [_ReserveSecurityToken_]()
...
**Returns:** [_ReserveSecurityToken_]()

## Properties

### `Protected` args

• **args**: [_ReserveSecurityTokenProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ReserveSecurityToken
...
▸ **prepareTransactions**\(\): _Promise‹PostTransactionResolver‹_[_SecurityTokenReservation_]()_, TransactionReceiptWithDecodedLogs››_
...
**Returns:** _Promise‹PostTransactionResolver‹_[_SecurityTokenReservation_]()_, TransactionReceiptWithDecodedLogs››_
