...
+ **new ModifyPercentageExemptions**\(`args`: [ModifyPercentageExemptionsProcedureArgs](), `context`: [Context]()\): [_ModifyPercentageExemptions_]()
...
**Returns:** [_ModifyPercentageExemptions_]()

## Properties

### `Protected` args

• **args**: [_ModifyPercentageExemptionsProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ModifyPercentageExemptions
