...
+ **new WithdrawTaxes**\(`args`: [WithdrawTaxesProcedureArgs](), `context`: [Context]()\): [_WithdrawTaxes_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.WithdrawTaxes
