...
* Procedure‹[CreateSecurityTokenProcedureArgs](), [SecurityToken]()›
...
+ **new CreateSecurityToken**\(`args`: [CreateSecurityTokenProcedureArgs](), `context`: [Context]()\): [_CreateSecurityToken_]()
...
**Returns:** [_CreateSecurityToken_]()

## Properties

### `Protected` args

• **args**: [_CreateSecurityTokenProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.CreateSecurityToken
...
▸ **prepareTransactions**\(\): _Promise‹PostTransactionResolver‹_[_SecurityToken_]()_, TransactionReceiptWithDecodedLogs››_
...
**Returns:** _Promise‹PostTransactionResolver‹_[_SecurityToken_]()_, TransactionReceiptWithDecodedLogs››_
