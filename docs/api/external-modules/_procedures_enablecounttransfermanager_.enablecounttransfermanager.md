...
+ **new EnableCountTransferManager**\(`args`: [EnableCountTransferManagerProcedureArgs](), `context`: [Context]()\): [_EnableCountTransferManager_]()
...
**Returns:** [_EnableCountTransferManager_]()

## Properties

### `Protected` args

• **args**: [_EnableCountTransferManagerProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.EnableCountTransferManager
