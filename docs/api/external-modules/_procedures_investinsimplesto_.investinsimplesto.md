...
+ **new InvestInSimpleSto**\(`args`: [InvestInSimpleStoProcedureArgs](), `context`: [Context]()\): [_InvestInSimpleSto_]()
...
**Returns:** [_InvestInSimpleSto_]()

## Properties

### `Protected` args

• **args**: [_InvestInSimpleStoProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.InvestInSimpleSto
