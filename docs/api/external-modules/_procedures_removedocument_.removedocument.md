...
+ **new RemoveDocument**\(`args`: [RemoveDocumentProcedureArgs](), `context`: [Context]()\): [_RemoveDocument_]()
...
**Returns:** [_RemoveDocument_]()

## Properties

### `Protected` args

• **args**: [_RemoveDocumentProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.RemoveDocument
