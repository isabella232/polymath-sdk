...
+ **new TieredStoFactory**\(`context`: [Context]()\): [_TieredStoFactory_]()

_Overrides_ [_Factory_]()_._[_constructor_]()

_Defined in_ [_src/entities/factories/TieredStoFactory.ts:148_](https://github.com/PolymathNetwork/polymath-sdk/blob/550676f/src/entities/factories/TieredStoFactory.ts#L148)
...
* \[ **key**: _string_\]: [TieredSto]() \| undefined
...
_Defined in_ [_src/entities/factories/TieredStoFactory.ts:13_](https://github.com/PolymathNetwork/polymath-sdk/blob/550676f/src/entities/factories/TieredStoFactory.ts#L13)
