...
+ **new ModifyMaxHolderCount**\(`args`: [ModifyMaxHolderCountProcedureArgs](), `context`: [Context]()\): [_ModifyMaxHolderCount_]()
...
**Returns:** [_ModifyMaxHolderCount_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ModifyMaxHolderCount
