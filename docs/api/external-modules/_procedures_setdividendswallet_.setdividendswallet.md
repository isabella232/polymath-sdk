...
+ **new SetDividendsWallet**\(`args`: [SetDividendsWalletProcedureArgs](), `context`: [Context]()\): [_SetDividendsWallet_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.SetDividendsWallet
