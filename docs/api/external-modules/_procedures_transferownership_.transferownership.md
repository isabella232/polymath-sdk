...
+ **new TransferOwnership**\(`args`: [TransferOwnershipProcedureArgs](), `context`: [Context]()\): [_TransferOwnership_]()
...
**Returns:** [_TransferOwnership_]()

## Properties

### `Protected` args

• **args**: [_TransferOwnershipProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.TransferOwnership
