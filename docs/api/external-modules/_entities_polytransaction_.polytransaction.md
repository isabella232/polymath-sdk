...
+ **new PolyTransaction**\(`transaction`: [TransactionSpec]()‹Args, Values, TransactionReceiptWithDecodedLogs \| string›, `transactionQueue`: [TransactionQueue]()‹any, any›\): [_PolyTransaction_]()
...
• **status**: [_TransactionStatus_]() = TransactionStatus.Idle
...
* **error**: _undefined \|_ [_PolymathError_]()
* **receipt**: _undefined \| string \| TransactionReceiptWithDecodedLogs_
* **status**: [_TransactionStatus_]()
* **tag**: [_PolyTransactionTag_]()
