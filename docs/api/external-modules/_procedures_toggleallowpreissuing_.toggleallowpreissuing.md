...
+ **new ToggleAllowPreIssuing**\(`args`: [ToggleAllowPreIssuingProcedureArgs](), `context`: [Context]()\): [_ToggleAllowPreIssuing_]()
...
**Returns:** [_ToggleAllowPreIssuing_]()

## Properties

### `Protected` args

• **args**: [_ToggleAllowPreIssuingProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.ToggleAllowPreIssuing
