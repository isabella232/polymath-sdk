...
+ **new AssignStoRole**\(`args`: [AssignStoRoleProcedureArgs](), `context`: [Context]()\): [_AssignStoRole_]()
...
**Returns:** [_AssignStoRole_]()

## Properties

### `Protected` args

• **args**: [_AssignStoRoleProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.AssignStoRole
