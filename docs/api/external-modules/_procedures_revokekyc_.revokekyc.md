...
* Procedure‹[RevokeKycProcedureArgs](), [Tokenholder]()\[\]›
...
+ **new RevokeKyc**\(`args`: [RevokeKycProcedureArgs](), `context`: [Context]()\): [_RevokeKyc_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.RevokeKyc
