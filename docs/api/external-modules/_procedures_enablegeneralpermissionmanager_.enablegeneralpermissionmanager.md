...
+ **new EnableGeneralPermissionManager**\(`args`: [EnableGeneralPermissionManagerProcedureArgs](), `context`: [Context]()\): [_EnableGeneralPermissionManager_]()
...
**Returns:** [_EnableGeneralPermissionManager_]()

## Properties

### `Protected` args

• **args**: [_EnableGeneralPermissionManagerProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.EnableGeneralPermissionManager
