...
+ **new SignTransferData**\(`args`: [SignTransferDataProcedureArgs](), `context`: [Context]()\): [_SignTransferData_]()
...
**Returns:** [_SignTransferData_]()

## Properties

### `Protected` args

• **args**: [_SignTransferDataProcedureArgs_]()
...
• **type**: [_ProcedureType_]() = ProcedureType.SignTransferData
