...
\+ **new SetDocument**(`args`: [SetDocumentProcedureArgs](../interfaces/_types_index_.setdocumentprocedureargs.md), `context`: [Context](_context_.context.md)): *[SetDocument](procedures.setdocument.md)*
...
*Defined in [src/procedures/SetDocument.ts:15](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/SetDocument.ts#L15)*
...
*Defined in [src/procedures/SetDocument.ts:25](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/SetDocument.ts#L25)*
