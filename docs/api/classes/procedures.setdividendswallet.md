...
* Procedure‹SetDividendsWalletProcedureArgs›
...
\+ **new SetDividendsWallet**(`args`: SetDividendsWalletProcedureArgs, `context`: [Context](_context_.context.md)): *[SetDividendsWallet](procedures.setdividendswallet.md)*
...
Name | Type |
------ | ------ |
`args` | SetDividendsWalletProcedureArgs |
...
• **type**: *ProcedureType* =  ProcedureType.SetDividendsWallet

*Overrides void*

*Defined in [src/procedures/SetDividendsWallet.ts:20](https://github.com/PolymathNetwork/polymath-sdk/blob/73ecb26/src/procedures/SetDividendsWallet.ts#L20)*
...
*Defined in [src/procedures/SetDividendsWallet.ts:29](https://github.com/PolymathNetwork/polymath-sdk/blob/73ecb26/src/procedures/SetDividendsWallet.ts#L29)*
