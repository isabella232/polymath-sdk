...
\+ **new WithdrawTaxes**(`args`: [WithdrawTaxesProcedureArgs](../interfaces/_types_index_.withdrawtaxesprocedureargs.md), `context`: [Context](_context_.context.md)): *[WithdrawTaxes](procedures.withdrawtaxes.md)*
...
*Defined in [src/procedures/WithdrawTaxes.ts:33](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/WithdrawTaxes.ts#L33)*
...
*Defined in [src/procedures/WithdrawTaxes.ts:42](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/WithdrawTaxes.ts#L42)*
