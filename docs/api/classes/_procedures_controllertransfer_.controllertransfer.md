...
+ **new ControllerTransfer**\(`args`: [ControllerTransferProcedureArgs](../interfaces/_types_index_.controllertransferprocedureargs.md), `context`: [Context](_context_.context.md)\): [_ControllerTransfer_](_procedures_controllertransfer_.controllertransfer.md)
...
**Returns:** [_ControllerTransfer_](_procedures_controllertransfer_.controllertransfer.md)
