...
+ **new TransferOwnership**\(`args`: [TransferOwnershipProcedureArgs](../interfaces/_types_index_.transferownershipprocedureargs.md), `context`: [Context](_context_.context.md)\): [_TransferOwnership_](_procedures_transferownership_.transferownership.md)
...
**Returns:** [_TransferOwnership_](_procedures_transferownership_.transferownership.md)
