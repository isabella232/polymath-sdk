...
+ **new RemoveDocument**\(`args`: [RemoveDocumentProcedureArgs](../interfaces/_types_index_.removedocumentprocedureargs.md), `context`: [Context](_context_.context.md)\): [_RemoveDocument_](_procedures_removedocument_.removedocument.md)
...
**Returns:** [_RemoveDocument_](_procedures_removedocument_.removedocument.md)
