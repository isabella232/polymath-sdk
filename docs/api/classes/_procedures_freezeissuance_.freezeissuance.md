...
+ **new FreezeIssuance**\(`args`: [FreezeIssuanceProcedureArgs](../interfaces/_types_index_.freezeissuanceprocedureargs.md), `context`: [Context](_context_.context.md)\): [_FreezeIssuance_](_procedures_freezeissuance_.freezeissuance.md)
...
**Returns:** [_FreezeIssuance_](_procedures_freezeissuance_.freezeissuance.md)
