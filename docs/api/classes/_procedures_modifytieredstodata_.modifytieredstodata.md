...
+ **new ModifyTieredStoData**\(`args`: [ModifyTieredStoDataProcedureArgs](../interfaces/_types_index_.modifytieredstodataprocedureargs.md), `context`: [Context](_context_.context.md)\): [_ModifyTieredStoData_](_procedures_modifytieredstodata_.modifytieredstodata.md)
...
**Returns:** [_ModifyTieredStoData_](_procedures_modifytieredstodata_.modifytieredstodata.md)
