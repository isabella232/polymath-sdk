...
+ **new SignFreezeIssuanceAck**\(`args`: [SignFreezeIssuanceAckProcedureArgs](../interfaces/_types_index_.signfreezeissuanceackprocedureargs.md), `context`: [Context](_context_.context.md)\): [_SignFreezeIssuanceAck_](_procedures_signfreezeissuanceack_.signfreezeissuanceack.md)
...
**Returns:** [_SignFreezeIssuanceAck_](_procedures_signfreezeissuanceack_.signfreezeissuanceack.md)
