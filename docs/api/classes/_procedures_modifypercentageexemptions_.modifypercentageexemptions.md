...
+ **new ModifyPercentageExemptions**\(`args`: [ModifyPercentageExemptionsProcedureArgs](../interfaces/_types_index_.modifypercentageexemptionsprocedureargs.md), `context`: [Context](_context_.context.md)\): [_ModifyPercentageExemptions_](_procedures_modifypercentageexemptions_.modifypercentageexemptions.md)
...
**Returns:** [_ModifyPercentageExemptions_](_procedures_modifypercentageexemptions_.modifypercentageexemptions.md)
...
_Defined in_ [_src/procedures/ModifyPercentageExemptions.ts:16_](https://github.com/PolymathNetwork/polymath-sdk/blob/550676f/src/procedures/ModifyPercentageExemptions.ts#L16)
...
_Defined in_ [_src/procedures/ModifyPercentageExemptions.ts:27_](https://github.com/PolymathNetwork/polymath-sdk/blob/550676f/src/procedures/ModifyPercentageExemptions.ts#L27)
