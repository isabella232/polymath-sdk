...
+ **new ToggleAllowBeneficialInvestments**\(`args`: [ToggleAllowBeneficialInvestmentsProcedureArgs](../interfaces/_types_index_.toggleallowbeneficialinvestmentsprocedureargs.md), `context`: [Context](_context_.context.md)\): [_ToggleAllowBeneficialInvestments_](_procedures_toggleallowbeneficialinvestments_.toggleallowbeneficialinvestments.md)
...
**Returns:** [_ToggleAllowBeneficialInvestments_](_procedures_toggleallowbeneficialinvestments_.toggleallowbeneficialinvestments.md)
