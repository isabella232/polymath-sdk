...
+ **new DisableController**\(`args`: [DisableControllerProcedureArgs](../interfaces/_types_index_.disablecontrollerprocedureargs.md), `context`: [Context](_context_.context.md)\): [_DisableController_](_procedures_disablecontroller_.disablecontroller.md)
...
**Returns:** [_DisableController_](_procedures_disablecontroller_.disablecontroller.md)
