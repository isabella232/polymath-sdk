...
\+ **new SignDisableControllerAck**(`args`: [SignDisableControllerAckProcedureArgs](../interfaces/_types_index_.signdisablecontrollerackprocedureargs.md), `context`: [Context](_context_.context.md)): *[SignDisableControllerAck](procedures.signdisablecontrollerack.md)*
...
*Defined in [src/procedures/SignDisableControllerAck.ts:14](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/SignDisableControllerAck.ts#L14)*
...
*Defined in [src/procedures/SignDisableControllerAck.ts:19](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/SignDisableControllerAck.ts#L19)*
