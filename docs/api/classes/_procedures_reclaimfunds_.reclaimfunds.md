...
+ **new ReclaimFunds**\(`args`: [ReclaimFundsProcedureArgs](../interfaces/_types_index_.reclaimfundsprocedureargs.md), `context`: [Context](_context_.context.md)\): [_ReclaimFunds_](_procedures_reclaimfunds_.reclaimfunds.md)
...
**Returns:** [_ReclaimFunds_](_procedures_reclaimfunds_.reclaimfunds.md)
...
_Defined in_ [_src/procedures/ReclaimFunds.ts:28_](https://github.com/PolymathNetwork/polymath-sdk/blob/550676f/src/procedures/ReclaimFunds.ts#L28)
...
_Defined in_ [_src/procedures/ReclaimFunds.ts:37_](https://github.com/PolymathNetwork/polymath-sdk/blob/550676f/src/procedures/ReclaimFunds.ts#L37)
