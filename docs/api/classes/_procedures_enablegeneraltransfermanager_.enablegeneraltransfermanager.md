...
+ **new EnableGeneralTransferManager**\(`args`: [EnableGeneralTransferManagerProcedureArgs](../interfaces/_types_index_.enablegeneraltransfermanagerprocedureargs.md), `context`: [Context](_context_.context.md)\): [_EnableGeneralTransferManager_](_procedures_enablegeneraltransfermanager_.enablegeneraltransfermanager.md)
...
**Returns:** [_EnableGeneralTransferManager_](_procedures_enablegeneraltransfermanager_.enablegeneraltransfermanager.md)
