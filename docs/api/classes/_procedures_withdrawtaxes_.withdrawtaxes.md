...
+ **new WithdrawTaxes**\(`args`: [WithdrawTaxesProcedureArgs](../interfaces/_types_index_.withdrawtaxesprocedureargs.md), `context`: [Context](_context_.context.md)\): [_WithdrawTaxes_](_procedures_withdrawtaxes_.withdrawtaxes.md)
...
**Returns:** [_WithdrawTaxes_](_procedures_withdrawtaxes_.withdrawtaxes.md)
