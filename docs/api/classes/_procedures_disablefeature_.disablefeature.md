...
+ **new DisableFeature**\(`args`: [DisableFeatureProcedureArgs](../interfaces/_types_index_.disablefeatureprocedureargs.md), `context`: [Context](_context_.context.md)\): [_DisableFeature_](_procedures_disablefeature_.disablefeature.md)
...
**Returns:** [_DisableFeature_](_procedures_disablefeature_.disablefeature.md)
