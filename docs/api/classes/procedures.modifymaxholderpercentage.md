...
\+ **new ModifyMaxHolderPercentage**(`args`: [ModifyMaxHolderPercentageProcedureArgs](../interfaces/_types_index_.modifymaxholderpercentageprocedureargs.md), `context`: [Context](_context_.context.md)): *[ModifyMaxHolderPercentage](procedures.modifymaxholderpercentage.md)*
...
*Defined in [src/procedures/ModifyMaxHolderPercentage.ts:20](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/ModifyMaxHolderPercentage.ts#L20)*
...
*Defined in [src/procedures/ModifyMaxHolderPercentage.ts:29](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/ModifyMaxHolderPercentage.ts#L29)*
