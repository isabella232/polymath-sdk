...
+ **new PushDividendPayment**\(`args`: [PushDividendPaymentProcedureArgs](../interfaces/_types_index_.pushdividendpaymentprocedureargs.md), `context`: [Context](_context_.context.md)\): [_PushDividendPayment_](_procedures_pushdividendpayment_.pushdividendpayment.md)
...
**Returns:** [_PushDividendPayment_](_procedures_pushdividendpayment_.pushdividendpayment.md)
