...
* [constructor](procedures.finalizesto.md#constructor)

### Properties

* [args](procedures.finalizesto.md#protected-args)
* [context](procedures.finalizesto.md#protected-context)
* [type](procedures.finalizesto.md#type)

### Methods

* [addProcedure](procedures.finalizesto.md#addprocedure)
* [addSignatureRequest](procedures.finalizesto.md#addsignaturerequest)
* [addTransaction](procedures.finalizesto.md#addtransaction)
* [prepare](procedures.finalizesto.md#prepare)
* [prepareTransactions](procedures.finalizesto.md#preparetransactions)

## Constructors

###  constructor

\+ **new FinalizeSto**(`args`: [FinalizeStoProcedureArgs](../interfaces/_types_index_.finalizestoprocedureargs.md), `context`: [Context](_context_.context.md)): *[FinalizeSto](procedures.finalizesto.md)*
...
**Returns:** *[FinalizeSto](procedures.finalizesto.md)*
...
*Defined in [src/procedures/FinalizeSto.ts:65](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/FinalizeSto.ts#L65)*
...
*Defined in [src/procedures/FinalizeSto.ts:100](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/FinalizeSto.ts#L100)*
