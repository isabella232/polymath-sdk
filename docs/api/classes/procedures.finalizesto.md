...
* Procedure‹FinalizeStoProcedureArgs›
...
\+ **new FinalizeSto**(`args`: FinalizeStoProcedureArgs, `context`: [Context](_context_.context.md)): *[FinalizeSto](procedures.finalizesto.md)*
...
• **type**: *ProcedureType* =  ProcedureType.FinalizeSto

*Overrides void*

*Defined in [src/procedures/FinalizeSto.ts:65](https://github.com/PolymathNetwork/polymath-sdk/blob/1abe1ae/src/procedures/FinalizeSto.ts#L65)*
...
*Defined in [src/procedures/FinalizeSto.ts:100](https://github.com/PolymathNetwork/polymath-sdk/blob/1abe1ae/src/procedures/FinalizeSto.ts#L100)*
