...
\+ **new ModifyPercentageExemptions**(`args`: [ModifyPercentageExemptionsProcedureArgs](../interfaces/_types_index_.modifypercentageexemptionsprocedureargs.md), `context`: [Context](_context_.context.md)): *[ModifyPercentageExemptions](procedures.modifypercentageexemptions.md)*
...
*Defined in [src/procedures/ModifyPercentageExemptions.ts:21](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/ModifyPercentageExemptions.ts#L21)*
...
*Defined in [src/procedures/ModifyPercentageExemptions.ts:32](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/ModifyPercentageExemptions.ts#L32)*
