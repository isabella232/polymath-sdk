...
+ **new ControllerRedeem**\(`args`: [ControllerRedeemProcedureArgs](../interfaces/_types_index_.controllerredeemprocedureargs.md), `context`: [Context](_context_.context.md)\): [_ControllerRedeem_](_procedures_controllerredeem_.controllerredeem.md)
...
**Returns:** [_ControllerRedeem_](_procedures_controllerredeem_.controllerredeem.md)
