...
\+ **new AssignSecurityTokenRole**(`args`: [AssignSecurityTokenRoleProcedureArgs](../interfaces/_types_index_.assignsecuritytokenroleprocedureargs.md), `context`: [Context](_context_.context.md)): *[AssignSecurityTokenRole](procedures.assignsecuritytokenrole.md)*
...
*Defined in [src/procedures/AssignSecurityTokenRole.ts:22](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/AssignSecurityTokenRole.ts#L22)*
...
*Defined in [src/procedures/AssignSecurityTokenRole.ts:33](https://github.com/PolymathNetwork/polymath-sdk/blob/454d285/src/procedures/AssignSecurityTokenRole.ts#L33)*
