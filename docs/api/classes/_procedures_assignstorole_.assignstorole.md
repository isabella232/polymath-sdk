...
\+ **new AssignStoRole**(`args`: [AssignStoRoleProcedureArgs](../interfaces/_types_index_.assignstoroleprocedureargs.md), `context`: [Context](_context_.context.md)): *[AssignStoRole](_procedures_assignstorole_.assignstorole.md)*
...
**Returns:** *[AssignStoRole](_procedures_assignstorole_.assignstorole.md)*
...
• **type**: *[ProcedureType](../enums/_types_index_.proceduretype.md)* =  ProcedureType.AssignStoRole

*Overrides void*

*Defined in [src/procedures/AssignStoRole.ts:17](https://github.com/PolymathNetwork/polymath-sdk/blob/550676f/src/procedures/AssignStoRole.ts#L17)*
...
*Defined in [src/procedures/AssignStoRole.ts:27](https://github.com/PolymathNetwork/polymath-sdk/blob/550676f/src/procedures/AssignStoRole.ts#L27)*
