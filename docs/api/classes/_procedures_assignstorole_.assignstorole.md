...
+ **new AssignStoRole**\(`args`: [AssignStoRoleProcedureArgs](../interfaces/_types_index_.assignstoroleprocedureargs.md), `context`: [Context](_context_.context.md)\): [_AssignStoRole_](_procedures_assignstorole_.assignstorole.md)
...
**Returns:** [_AssignStoRole_](_procedures_assignstorole_.assignstorole.md)
