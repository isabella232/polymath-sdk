[@polymathnetwork/sdk - v2.0.1-beta.120](../README.md) › [Globals](../globals.md) › ["procedures/DisableController"](../modules/_procedures_disablecontroller_.md) › [DisableController](_procedures_disablecontroller_.disablecontroller.md)
...
- Procedure‹[DisableControllerProcedureArgs](../interfaces/_types_index_.disablecontrollerprocedureargs.md)›
...
- [constructor](_procedures_disablecontroller_.disablecontroller.md#constructor)

### Properties

- [args](_procedures_disablecontroller_.disablecontroller.md#protected-args)
- [context](_procedures_disablecontroller_.disablecontroller.md#protected-context)
- [type](_procedures_disablecontroller_.disablecontroller.md#type)

### Methods

- [addProcedure](_procedures_disablecontroller_.disablecontroller.md#addprocedure)
- [addSignatureRequest](_procedures_disablecontroller_.disablecontroller.md#addsignaturerequest)
- [addTransaction](_procedures_disablecontroller_.disablecontroller.md#addtransaction)
- [prepare](_procedures_disablecontroller_.disablecontroller.md#prepare)
- [prepareTransactions](_procedures_disablecontroller_.disablecontroller.md#preparetransactions)

## Constructors

### constructor

\+ **new DisableController**(`args`: [DisableControllerProcedureArgs](../interfaces/_types_index_.disablecontrollerprocedureargs.md), `context`: [Context](_context_.context.md)): _[DisableController](_procedures_disablecontroller_.disablecontroller.md)_
...
| Name      | Type                                                                                            |
| --------- | ----------------------------------------------------------------------------------------------- |
| `args`    | [DisableControllerProcedureArgs](../interfaces/_types_index_.disablecontrollerprocedureargs.md) |
| `context` | [Context](_context_.context.md)                                                                 |

**Returns:** _[DisableController](_procedures_disablecontroller_.disablecontroller.md)_

## Properties

### `Protected` args

• **args**: _[DisableControllerProcedureArgs](../interfaces/_types_index_.disablecontrollerprocedureargs.md)_
...
• **type**: _[ProcedureType](../enums/_types_index_.proceduretype.md)_ = ProcedureType.DisableController

_Overrides void_

_Defined in [src/procedures/DisableController.ts:14](https://github.com/PolymathNetwork/polymath-sdk/blob/1da5bc5/src/procedures/DisableController.ts#L14)_
...
_Defined in [src/procedures/DisableController.ts:24](https://github.com/PolymathNetwork/polymath-sdk/blob/1da5bc5/src/procedures/DisableController.ts#L24)_
